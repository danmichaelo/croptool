...
/**
 * Class by Andrew Johnson Jun 2, 2009 (modified Sep 22, 2009)
 ...
 *
 *   - Uses the RIJNDAEL-256 block cipher in CRT mode;
 *   - Generates a unique IV for every encryption procedure;
 *   - Prepends IV's to ciphertext for easier transmission / storage;
 *   - Provides message confidentiality and message integrity via a MAC;
 *   - Supports the encryption of PHP variables and arrays;
 *   - Ability to generate encryption keys according to the RSA PBKDF2 standard.
 */
class Cryptastic {
    ...
    */
     ...
     *
     * Note: pbkdf2 was added in PHP 5.5, so at some point
